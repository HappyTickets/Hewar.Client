...
export class ContractService {
  ...
  GetContractKeysByContractId(contractId: number):Observable <IApiResponse<IContractTemplate>> {
    return this.http.get<IApiResponse<IContractTemplate>>(`${this.baseEndPoint}GetContractKeysByContractId`, {params: {contractId}})
  }
  GetContractKeysByOfferId(offerId: number):Observable <IApiResponse<IContractTemplate>> {
    return this.http.get<IApiResponse<IContractTemplate>>(`${this.baseEndPoint}GetContractKeysByOfferId`, {params: {offerId}})
  }
